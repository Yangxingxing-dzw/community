...
&nbsp;&nbsp;（1）首先将arcy_train_16.pt、darcy_test_16.pt、darcy_test_32.pt等数据集[https://github.com/neuraloperator/neuraloperator/tree/0.3.0/neuralop/datasets/datad](https://github.com/neuraloperator/neuraloperator/tree/0.3.0/neuralop/datasets/datad)转化为ndarray格式；
